...
public interface ImCategCodDao {
...
//	public List getProductWithImage(String categoryId) throws Exception;
	List<ImItem> getProductByField(String field, Object value) throws Exception;
